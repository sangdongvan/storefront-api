...
) : Controller
{
    ...
    public async Task<IActionResult> Token()
    {
        ...
        if (request.IsPasswordGrantType())
        {
            ...
            // Token's scope is not supported. Use offline_access scope for issuing Refresh Token.
            identity.SetScopes("offline_access");
    ...
    [HttpGet("~/_connect/openid-configuration")]
    public Task OpenIdConfiguration()
    {
        // For document purpose, this line is never run.
        return Task.CompletedTask;
    }
   
    [HttpGet("~/_connect/jwks")]
    public Task Jwks()
    {
        // For document purpose, this line is never run.
        return Task.CompletedTask;
